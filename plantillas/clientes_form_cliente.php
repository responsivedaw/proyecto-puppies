...
<form action="" name="clientes" id="clientes" method="post" role="form">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-2 col-xs-2">
            ...
            <input type="text" name="fnac_cliente" id="fnac_cliente" class="form-control calendario" placeholder="DD/MM/AAAA" <?php echo (isset($cliente['fnac_cliente']))?'value="'.formatear_fecha($cliente['fnac_cliente']).'"':''; ?> data-validation="date" data-validation-format="dd/mm/yyyy" data-validation-error-msg="Introduzca una fecha correcta." />
        </div>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-4 col-xs-6">
            ...
            <select name="cpostal_cliente" id="cpostal_cliente" class="form-control" data-validation="required" data-validation-error-msg="Seleccione una localidad." />
