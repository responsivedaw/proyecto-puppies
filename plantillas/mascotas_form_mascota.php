...
<form action="" name="mascotas" id="mascotas" method="post" role="form" enctype="multipart/form-data">
    <div class="row">
        <div class="col-md-9">
            <div class="row">
                ...
                <div class="form-group col-xs-2 col-xs-offset-5 col-md-3 col-md-offset-4">
            ...
            <div class="row">
                ...
                <div class="form-group col-xs-2 col-xs-offset-1 col-md-3 col-md-offset-1">
            ...
            <div class="row">
                ...
                <div class="form-group col-xs-4 col-xs-offset-1 col-md-4 col-md-offset-1">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-control input-sm">
                            <label for="librovac_mascota">LIBRO VACUNAS</label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="form-group col-xs-3 col-xs-offset-1 col-md-3 col-md-offset-1">
        ...
        <div class="form-group col-xs-2 col-md-2">
            ...
            <input type="text" name="nif_cliente" id="nif_cliente" class="form-control input-sm" placeholder="NIF Cliente" <?php echo (isset($nif))?'value="'.$nif.'"':''; ?> disabled="disabled" />
        </div>
    </div>
    <div class="row">
        <div class="form-group col-xs-2 col-md-2">
        ...
        <div class="form-group col-xs-2 col-md-2">
            <label for="">&nbsp;</label>
            <div class="input-group">
            <a href="<?php echo (isset($id_cliente))?'./clientes.php?visualizar=true&id_cliente='.$id_cliente:'#'; ?>" id="link-cliente" title="IR A FICHA" class="btn btn-success btn-sm"><i class="fa fa-eye fa-lg"></i>&nbsp;&nbsp;FICHA&nbsp;&nbsp;</a>
            </div>
        </div>
    </div>
    <div class="line-break"></div>
