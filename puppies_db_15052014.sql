...
--
-- Servidor: localhost
-- Tiempo de generación: 15-05-2014 a las 18:46:04
...
CREATE TABLE IF NOT EXISTS `articulos` (
  ...
  `stock_articulo` decimal(8,2) NOT NULL DEFAULT '0.00',
  `prcompra_articulo` decimal(8,2) NOT NULL,
  `prventa_articulo` decimal(8,2) NOT NULL,
  `iva_articulo` int(2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `cpostal_cliente` varchar(5) DEFAULT NULL,
  ...
  KEY `fk_clientes_localidades1_idx` (`cpostal_cliente`),
...
INSERT INTO `clientes` (`id_cliente`, `nif_cliente`, `nombre_cliente`, `apellidos_cliente`, `fnac_cliente`, `falta_cliente`, `sexo_cliente`, `direccion_cliente`, `cpostal_cliente`, `tfno1_cliente`, `tfno2_cliente`, `email_cliente`, `mailing_cliente`, `notas_cliente`, `activo_cliente`, `id_usuario`) VALUES
...
CREATE TABLE IF NOT EXISTS `lineas_facturas` (
  ...
  `ctad_articulo` decimal(8,2) NOT NULL DEFAULT '1.00',
  `precio_articulo` decimal(8,2) NOT NULL,
  `descuento_linea` int(2) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `mascotas` (
  ...
  `peso_mascota` decimal(8,2) DEFAULT NULL,
...
(1, 'Yacky', 'Mestizo', 'ABF7894526', '2008-06-01', '10.00', 'macho', 'Alergico a las alergias ...', 1, 'foto01.jpg', 1, 1, 4),
(2, 'Princess', 'Caniche', 'EGF4526398', '2010-03-01', '4.00', 'hembra', 'Alergico a las alergias ...', 1, 'foto01.jpg', 5, 1, 4),
(3, 'Canela', 'Boxer', 'GGF0125221', '2003-10-01', '15.00', 'hembra', NULL, 1, 'foto01.jpg', 1, 1, 4),
(4, 'Sherlock', 'Pointer', 'CDC0023665', '2010-03-01', '10.00', 'macho', 'Un verdadero detective.', 1, 'foto01.jpg', 3, 1, 4),
(5, 'Guacamole', 'Bulldog Francés', 'FFD7451236', '2008-12-01', '9.00', 'macho', 'Le encanta el guacamole ...', 0, 'foto01.jpg', 4, 1, 4),
(6, 'Diana', 'Akita', 'RET1002533', '2011-06-01', '9.00', 'hembra', 'Alergico a las alergias ...', 1, 'foto01.jpg', 9, 1, 4),
(7, 'Bond', 'Carlino', 'ASD4568523', '2006-01-01', '8.00', 'macho', 'Alergico a las alergias ...', 1, 'foto01.jpg', 3, 1, 4),
(8, 'Vertigo', 'Pastor Australiano', 'XXX2342344', '2007-03-01', '18.00', 'macho', 'Más rapido que el trueno ...', 0, 'foto01.jpg', 8, 1, 4),
(9, 'Princesa', 'Collie', 'AED5698523', '2010-09-01', '7.00', 'hembra', NULL, 1, 'foto01.jpg', 6, 1, 4),
(10, 'Cafeto', 'Labrador', 'ABF7894526', '2008-06-01', '10.00', 'macho', 'Alergico a las alergias ...', 1, 'foto01.jpg', 4, 1, 4);
...
ALTER TABLE `clientes`
  ...
  ADD CONSTRAINT `fk_customers_cities1` FOREIGN KEY (`cpostal_cliente`) REFERENCES `localidades` (`cpostal_localidad`) ON DELETE NO ACTION ON UPDATE NO ACTION;
